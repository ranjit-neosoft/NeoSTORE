...
static const CGFloat SVProgressHUDRingRadius = 16; //18;
...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        SVProgressHUDBackgroundColor = UIColorFromRGB(0xaaaaaa);
        SVProgressHUDForegroundColor = UIColorFromRGB(0x009AD9);
...
//    self.frame = UIScreen.mainScreen.bounds;//swapnali change commented
...
//    CGFloat posY = floor(activeHeight*0.45);
    CGFloat posY = CGRectGetHeight(orientationFrame)/2;
...
- (UILabel *)stringLabel {
    ...
    _stringLabel.textColor = [UIColor darkGrayColor]; //SVProgressHUDForegroundColor;
